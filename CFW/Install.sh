...
menu() {
    clear
    echo -e 
    echo -e "${cyan}1)${rest} ${green}Install${rest}"
    echo -e ""
    echo -e "${cyan}2)${rest} ${green}Install[${yellow}Arm${green}]${rest}"
    echo -e ""
    echo -e "${cyan}3)${rest} ${green}Uninstall${rest}"
    echo -e ""
    echo -e "${cyan}4)${rest} ${green}Upgrade${rest}"
    echo -e ""
    echo -e "${cyan}5)${rest} ${green}Build${rest}"
    echo -e ""
